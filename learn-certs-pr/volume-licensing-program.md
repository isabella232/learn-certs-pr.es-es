...
* **[Licencias por volumen de Microsoft para Software Assurance](https://www.microsoft.com/learning/software-assurance-benefits.aspx)**. Un programa rentable que otorga acceso a aprendizaje electrónico específico de Software Assurance y capacitación dirigida por un instructor a través de su cobertura actual de Software Assurance.
...
* Bibliotecas de referencia electrónica de Microsoft
  ...
  * [Ver ejemplos de contenido de la Biblioteca de referencia electrónica](https://mseref.safaribooksonline.com/)
...
* Microsoft Imagine Academy (para organizaciones elegibles)
  ...
  El programa Microsoft Imagine Academy ofrece un plan de estudios de tecnología de primer nivel del siglo XXI para mantenerse actualizado sobre las últimas tecnologías de Microsoft. Los educadores pueden integrar fácilmente planes de lecciones de tecnología, aprendizaje electrónico, proyectos de estudiantes y evaluaciones en planes de estudio nuevos o existentes para estudiantes de todas las edades y niveles de experiencia. Además, el programa Imagine Academy brinda a los educadores y al personal oportunidades de desarrollo profesional.

  Imagine Academy ofrece lo siguiente:

  * Acceso a cursos de aprendizaje en línea de Microsoft
  * El Instructor Learning Management System (LMS) para ayudar a rastrear y monitorear el progreso del estudiante
  * Descuentos en cursos oficiales (disponibles solo para instituciones académicas)
  * Recursos de marketing para promover la asociación con la marca Microsoft y certificaciones oficiales.

  El programa educativo listo para la universidad y la carrera está disponible para todas las instituciones académicas acreditadas como una membresía de suscripción. Para participar en el [programa Microsoft Imagine Academy](https://www.microsoft.com/es-es/education/imagine-academy/default.aspx), debe mantener ciertos [estándares y requisitos](https://www.microsoft.com/es-es/education/imagine-academy/become-a-member/default.aspx).
...
* Paquetes de examen de certificación de Microsoft para instituciones académicas
  ...
  | Producto de certificación | Descripción | Número de comprobantes de examen por sitio/paquete de clase |
  | --- | --- | --- |
  | MOS/MTA/MCE Site Pack | Paquetes de 500 exámenes que se pueden usar como una combinación para los exámenes MOS, MTA y MCE. Los exámenes MOS validan la comprensión general y la profunda experiencia de las habilidades de Office que requieren las empresas, diferenciando a los estudiantes y mejorando sus posibilidades de éxito a medida que ingresan a la educación superior o ingresan a la fuerza laboral. Los exámenes MTA validan los conceptos básicos de tecnología en infraestructura, base de datos y desarrollo, ayudando a los estudiantes a prepararse para una educación y/o certificaciones tecnológicas más avanzadas. La certificación MTA se puede obtener en un semestre y se puede utilizar para demostrar la capacidad y el compromiso para los puestos de TI de nivel de entrada. El programa Microsoft Certified Educator (MCE) proporciona herramientas sólidas que ayudan a los educadores a impulsar la mejor integración de la tecnología de la información y la comunicación (TIC) en la enseñanza en el aula. Asignado al Marco de Competencias TIC de la UNESCO para Educadores. | 500 |
  | MTA/MCE and MOS/MCE Site Pack |  Paquetes de 125 exámenes que se pueden usar una combinación de exámenes MTA / MCE o MOS / MCE. Los exámenes MOS validan la comprensión general y la profunda experiencia de las habilidades de Office que requieren las empresas, diferenciando a los estudiantes y mejorando sus posibilidades de éxito a medida que ingresan a la educación superior o ingresan a la fuerza laboral. Los exámenes MTA validan los conceptos básicos de tecnología en infraestructura, base de datos y desarrollo, ayudando a los estudiantes a prepararse para una educación y/o certificaciones tecnológicas más avanzadas. La certificación MTA se puede obtener en un semestre y se puede utilizar para demostrar la capacidad y el compromiso para los puestos de TI de nivel de entrada. El programa Microsoft Certified Educator (MCE) proporciona herramientas sólidas que ayudan a los educadores a impulsar la mejor integración de la tecnología de la información y la comunicación (TIC) en la enseñanza en el aula. Asignado al Marco de Competencias TIC de la UNESCO para Educadores. | 125 |
  | Microsoft Certified Professional (MCP) Class Pack | Los comprobantes de examen MCP se pueden usar para obtener las certificaciones de Microsoft Certified Solutions Associate (MCSA), Microsoft Certified Solutions Expert (MCSE) o Microsoft Certified Solutions Developer (MCSD). Estas certificaciones validan habilidades que son cruciales para las carreras actuales en TI. Las certificaciones MCSA validan las habilidades de la plataforma central, y MCSD y MCSE validan la profunda experiencia necesaria para diseñar, construir e implementar soluciones. | 30 |

  Puede solicitar su membresía anual de Microsoft Imagine Academy y los paquetes de examen de Certificación de Microsoft a través de los siguientes programas de Licencias por Volumen Académico de Microsoft:

  * Inscripción para soluciones educativas (EES)
  * Matrícula escolar (bajo un acuerdo de campus y escuela)
  * Seleccione Plus para Academic

  Para obtener más información, póngase en contacto con su distribuidor de licencias académicas o visite la página [Programas de licencias de Microsoft para industrias](https://www.microsoft.com/licensing/licensing-options/for-industries.aspx).

  **Recursos adicionales de certificación académica de licencias por volumen**

  * [Guía de beneficios del programa Microsoft Imagine Academy](https://download.microsoft.com/download/C/6/1/C616A2EB-0245-48AC-9ECA-BBEBB1B781C6/Imagine_Academy_FactSheet.pdf)
  * [Hoja de datos de la Certificación de Microsoft para Instituciones Académicas](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/IT_Academy-Cert_Datasheet.pdf)
  ...
  * [Paquetes de examen de certificación de Microsoft para la hoja de datos de Licencias por volumen académicas](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/ITA-Cert_VLflyer_Customer.pdf)
...
* Recursos académicos adicionales de e-learning para licencias por volumen
  ...
  * [Demostración de activación de E-Learning](https://www.microsoft.com/learning/_silverlight/vl/vl.htm)
  * [Guía del Centro de Administración de Empresas para uso en línea](https://www.microsoft.com/learning/_silverlight/bac/bac.htm)
  ...
  * [Hoja de ruta de certificación de Microsoft Imagine Academy](https://download.microsoft.com/download/C/6/1/C616A2EB-0245-48AC-9ECA-BBEBB1B781C6/Certification_Roadmap_A1_ENU.pdf)
  * [Paquetes de examen de certificación de Microsoft para Licencias por volumen académico](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/ITA-Cert_VLflyer_Customer.pdf)
...
Las siguientes preguntas abordan específicamente las licencias por volumen para las soluciones de capacitación y certificación de Microsoft. Visite la [descripción general de la certificación](https://www.microsoft.com/learning/certification-overview.aspx) o [políticas de examen y preguntas frecuentes](https://www.microsoft.com/learning/certification-exam-policies.aspx) para obtener respuestas a preguntas generales sobre la certificación de Microsoft o los exámenes.
...
* **Código de la Biblioteca de referencia electrónica de Microsoft**. Para acceder a la biblioteca, debe tener una licencia. Después de que la biblioteca se haya desbloqueado, tendrá acceso hasta el final de su acuerdo de Licenciamiento por volumen.
...
**Nota** Si solicita soluciones de capacitación y certificación de Microsoft como una suscripción de 12 meses, los pedidos posteriores caducarán al mismo tiempo que el pedido de suscripción inicial de 12 meses. [Visite la guía de servicios en línea](https://www.microsoft.com/learning/_silverlight/bac/bac.htm).
...
- [Encuentre su Microsoft Certified Partner local para soluciones de capacitación y certificación de Microsoft](https://www.microsoft.com/learning/find-partner.aspx)
...
Cada examen tiene materiales de preparación disponibles. Elija el examen de la [nueva lista de exámenes](https://www.microsoft.com/learning/exam-list.aspx) y luego busque las opciones de preparación disponibles para el examen.
...
Si está entregando certificaciones de TI de Microsoft y exámenes de paquete de sitio MCP, visite el sitio web de Pearson VUE para saber cómo su institución puede convertirse en un [centro de pruebas de Pearson VUE](https://www.pearsonvue.com/microsoft). Los exámenes de certificación MOS y MTA se entregan a través de Certiport.
...
**P: Después de ordenar un paquete de sitio MOS o MTA a través de licencias por volumen, ¿cómo se me notificará el acceso a los comprobantes de examen?**
