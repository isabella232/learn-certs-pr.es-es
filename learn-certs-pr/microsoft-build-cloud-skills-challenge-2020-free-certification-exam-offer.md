...
<br/><br/> 
[Haga clic en el botón Verificar cuenta en la página Descuentos de examen](images/step5.png)

**Paso 6:** Cuando verifica su cuenta, debe autenticarla con la misma cuenta utilizada para registrarse en el evento (NOTA: Si utilizó una cuenta de Microsoft para registrarse en el evento, debe usar la misma cuenta de Microsoft para iniciar sesión en su Perfil de Certificación para programar su examen. Si esta acción genera dos Perfiles de certificación, comuníquese con [Soporte de Microsoft Certification](https://trainingsupport.microsoft.com/en-us/mcp/forum) para combinar sus perfiles después de completar su examen.)
<br/><br/>
![Autenticar usando la misma cuenta social para verificar la cuenta](images/step6.png)

**Paso 7:** Siga los pasos en las pantallas siguientes y proporcione los detalles necesarios para programar su examen. Cuando realice el pago, verifique que el monto total adeudado es $0.00 y envíe la orden.
<br/><br/>
! [Proporcione la información necesaria para programar su examen](images/step7.png)
